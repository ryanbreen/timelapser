...
export const getGoldenHourMargin = (date) => {
    const dateSun = suncalc.getTimes(date, 43.884054, -72.285053)
    return {
        start: dateSun.sunrise.getTime() - (60 * 1000),
        end: dateSun.sunrise.getTime() + (60 * 1000)
    }
}

export const getNoonMargin = (date) => {
    const dateSun = suncalc.getTimes(date, 43.884054, -72.285053)
    return {
        start: dateSun.solarNoon.getTime() - (60 * 1000),
        end: dateSun.solarNoon.getTime() + (60 * 1000)
    }
}
